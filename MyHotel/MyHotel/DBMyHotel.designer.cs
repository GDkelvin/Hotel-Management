...
namespace MyHotel
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="MyHotel")]
    ...
    partial void Deleterating(rating instance);
		...
		public DBMyHotelDataContext() : 
				base(global::MyHotel.Properties.Settings.Default.MyHotelConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnroomidChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="customer_rating", Storage="_ratings", ThisKey="cid", OtherKey="cid")]
    ...
    partial void OnbookedChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="room_rating", Storage="_ratings", ThisKey="roomid", OtherKey="roomid")]
		public EntitySet<rating> ratings
		{
			get
			{
    ...
    partial void OncidChanging(int value);
    partial void OncidChanged();
    partial void Onrating1Changing(string value);
    ...
    partial void OncommentChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Name="rating", Storage="_rating1", DbType="VarChar(255) NOT NULL", CanBeNull=false)]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="customer_rating", Storage="_customer", ThisKey="cid", OtherKey="cid", IsForeignKey=true)]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="room_rating", Storage="_room", ThisKey="roomid", OtherKey="roomid", IsForeignKey=true)]
		public room room
		{
			get
			{
